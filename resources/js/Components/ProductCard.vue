            ...
            <div class="md:hidden absolute inset-x-0 bottom-0 p-3 z-40 bg-gradient-to-t from-black/80 via-black/20 to-transparent pointer-events-none">
                <div class="flex flex-col gap-2 p-3 pointer-events-auto">
                    ...
                    <div class="flex gap-2 mt-1">
                        <button 
                            @click.stop="cart.addItem(product)"
                            class="flex-1 flex items-center justify-center py-2.5 active:scale-95 transition-all"
                        >
                            <span class="material-symbols-outlined text-[20px] text-white">shopping_bag</span>
                        </button>
                        <a 
                            :href="whatsappUrl" 
                            target="_blank" 
