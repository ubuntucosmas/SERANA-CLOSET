        ...
        <div :class="[
            ...
            <div class="md:hidden absolute inset-x-0 bottom-0 p-4 z-40 bg-gradient-to-t from-black/90 via-black/40 to-transparent pointer-events-none pb-5">
                <div class="flex flex-col gap-4 pointer-events-auto mt-8">
                    ...
                    <div class="flex gap-3 justify-end -mt-6 pr-1">
                        <button 
                            @click.stop="cart.addItem(product)"
                            class="w-8 h-8 rounded-full bg-white/10 backdrop-blur-md flex items-center justify-center active:scale-95 transition-all text-white hover:bg-white hover:text-black shadow-lg"
                        >
                        ...
                        <a 
                            ...
                            target="_blank" 
                            @click.stop
                            class="w-8 h-8 rounded-full bg-[#25D366]/20 backdrop-blur-md flex items-center justify-center active:scale-95 transition-all hover:bg-[#25D366] text-[#25D366] hover:text-white shadow-lg"
                        >
