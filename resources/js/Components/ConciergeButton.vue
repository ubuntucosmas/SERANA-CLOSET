<template>
    <div @click="openWhatsApp" class="fixed bottom-6 right-6 z-[100] group cursor-pointer">
        <div class="flex items-center gap-3">
            ...
            <!-- Icon Bubble -->
            <div class="w-14 h-14 bg-primary rounded-full flex items-center justify-center shadow-[0_0_40px_rgba(182,143,101,0.3)] group-hover:scale-110 group-hover:bg-white transition-all duration-500">
                <svg viewBox="0 0 24 24" class="w-7 h-7 fill-background group-hover:fill-primary transition-colors">
