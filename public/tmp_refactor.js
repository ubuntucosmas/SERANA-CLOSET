...
// Special case: text-black is correct for buttons, but maybe change text-white/XX to text-secondary where appropriate, though text-white/40 works fine organically. Let's just fix the main structure and colors first.
